...
To create complex 3D models within your browser a texture is applied over a mesh of triangles, so the triangle is often a basic structure for WebGL graphics ( and OpenGL graphics ).
